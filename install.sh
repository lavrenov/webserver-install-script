...
apt-get install software-properties-common -y 2>> "$log"
...
apt-get install php7.2 php7.2-fpm -y 2>> "$log"
...
apt-get install apache2 libapache2-mod-php libapache2-mod-fcgid -y 2>> "$log"
...
a2enmod actions fcgid alias proxy_fcgi 2>> "$log"

...
apt-get install php7.4 php7.4-mysql php7.4-curl php7.4-json php7.4-gd php7.4-zip php7.4-mbstring php7.4-xml php7.4-xmlrpc php7.4-gmp php7.4-memcached php7.4-intl php7.4-bcmath -y 2>>"$log"
